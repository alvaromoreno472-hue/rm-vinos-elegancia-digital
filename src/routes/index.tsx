...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Ricardo Moreno · Vinos con Historia | Distribución de vinos en Guadalajara" },
      {
        name: "description",
        content:
          "Seleccionamos y distribuimos vinos con carácter desde Guadalajara. Venta mayorista para hostelería y comercios, y tienda online para particulares.",
      },
      { property: "og:title", content: "Ricardo Moreno · Vinos con Historia" },
      {
        property: "og:description",
        content: "Distribución de vinos con carácter · Guadalajara.",
      },
...
function Index() {
  const featured = FEATURED_SLUGS.map((slug) => WINES.find((w) => w.slug === slug)!).filter(
    Boolean,
  );
  return (
    <>
      <section className="relative isolate overflow-hidden bg-wine-deep text-cream">
        ...
        <div className="relative mx-auto flex min-h-[85vh] max-w-5xl flex-col items-center justify-center px-6 py-32 text-center">
          <p className="eyebrow text-gold">Vinos con Historia · Guadalajara</p>
          ...
          <p className="mt-8 max-w-xl text-base leading-relaxed text-cream/80 md:text-lg">
            Seleccionamos y distribuimos vinos con carácter de pequeñas bodegas españolas, para
            hostelería, comercios y amantes del buen vino.
          </p>
      ...
      <section className="border-b border-border/60 bg-cream-warm">
        <div className="mx-auto max-w-3xl px-6 py-24 text-center">
          ...
          <p className="mt-8 font-display text-3xl leading-relaxed text-wine-deep md:text-4xl">
            «Detrás de cada botella hay una bodega y una historia. Nuestro trabajo es encontrarlas y
            ponerlas en tu mesa.»
          </p>
          <p className="mt-8 text-sm uppercase tracking-[0.24em] text-muted-foreground">
            — Ricardo Moreno, fundador
          </p>
        </div>
      </section>
      ...
      <section className="bg-wine text-cream">
        <div className="mx-auto grid max-w-7xl gap-0 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center px-8 py-20 md:px-16 lg:py-24">
            <p className="eyebrow text-gold">De la bodega a tu copa</p>
            <h2 className="mt-4 font-display text-4xl leading-tight md:text-5xl">
              Selección con criterio propio
            </h2>
            <div className="mt-5 h-px w-16 bg-gold" />
            <p className="mt-8 text-base leading-relaxed text-cream/80">
              Visitamos bodegas, catamos cada referencia y elegimos solo las que tienen algo que
              contar. Trabajamos con pequeños y medianos productores de distintas regiones de
              España, cuidando cada entrega hasta que llega a su destino.
            </p>
            <Link
              to="/historia"
      ...
      <section className="mx-auto max-w-7xl px-6 py-24 md:py-32">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {[
            {
              text: "Selección cuidada y trato cercano. Nuestros clientes notan la diferencia en cada botella que servimos.",
              author: "Bar El Rincón",
              meta: "Cliente mayorista",
            },
            {
              text: "Encontrar vinos con historia real, a buen precio y con entrega rápida, no es fácil. Aquí lo consiguen.",
              author: "Tienda Gourmet Alcarria",
              meta: "Cliente mayorista",
            },
            {
              text: "Pedí online por curiosidad y repetí a la semana siguiente. Vinos con carácter de verdad.",
              author: "Cliente particular",
              meta: "Compra en tienda online",
            },
          ].map((t) => (
